...
class Enigma
  ...
  def encrypt(message, key = @key, offset = @offset)
    {
      encryption: message_encrypt(message, key, offset),
      key: key,
      date: offset
    }
  end
